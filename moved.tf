...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.express_route_gateways.azurerm_express_route_gateway.express_route_gateway["prod"]
}

moved {
  from = module.expressroute_gateways["prod_eu"].module.this.azurerm_express_route_gateway.express_route_gateway["gateway"]
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.express_route_gateways.azurerm_express_route_gateway.express_route_gateway["prod_eu"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.vpn_gateway.azurerm_vpn_gateway.vpn_gateway["prod"]
}

moved {
  from = module.site_to_site_vpns["prod"].module.vpn_sites.azurerm_vpn_site.vpn_site["prod"]
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.vpn_site.azurerm_vpn_site.vpn_site["prod-prod"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod"].azapi_resource.vnet
}

moved {
  from = module.private_dns_resolvers["prod"].module.sidecar_virtual_network.module.subnet["inbound"].azapi_resource.subnet[0]
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod"].module.subnet["dns_resolver"].azapi_resource.subnet
}

moved {
  from = module.private_dns_resolvers["prod"].module.sidecar_virtual_network.module.subnet["outbound"].azapi_resource.subnet[0]
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod"].module.subnet["outbound"].azapi_resource.subnet
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.virtual_network_connections.azurerm_virtual_hub_connection.hub_connection["private_dns_vnet_prod"]
}

moved {
  from = module.private_dns_resolvers["prod"].module.dns_resolver.azurerm_private_dns_resolver.this
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver.this
}

moved {
  from = module.private_dns_resolvers["prod"].module.dns_resolver.azurerm_private_dns_resolver_inbound_endpoint.this["default"]
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver_inbound_endpoint.this["default"]
}

moved {
  from = module.private_dns_resolvers["prod"].module.dns_resolver.azurerm_private_dns_resolver_outbound_endpoint.this["default"]
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver_outbound_endpoint.this["default"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver_dns_forwarding_ruleset.this["default-ruleset-default-default"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver_forwarding_rule.this["default-ruleset-default-default-corp"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].azurerm_private_dns_resolver_virtual_network_link.default["default-ruleset-default-default"]
}

moved {
  from = module.private_dns_resolvers["prod"].module.dns_resolver.terraform_data.outbound["default-ruleset-default-default"]
  to   = module.alz_connectivity[0].module.dns_resolver["prod"].terraform_data.outbound["default-ruleset-default-default"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod_eu"].azapi_resource.vnet
}

moved {
  from = module.private_dns_resolvers["prod_eu"].module.sidecar_virtual_network.module.subnet["inbound"].azapi_resource.subnet[0]
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod_eu"].module.subnet["dns_resolver"].azapi_resource.subnet
}

moved {
  from = module.private_dns_resolvers["prod_eu"].module.sidecar_virtual_network.module.subnet["outbound"].azapi_resource.subnet[0]
  to   = module.alz_connectivity[0].module.virtual_network_side_car["prod_eu"].module.subnet["outbound"].azapi_resource.subnet
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.virtual_wan[0].module.virtual_network_connections.azurerm_virtual_hub_connection.hub_connection["private_dns_vnet_prod_eu"]
}

moved {
  from = module.private_dns_resolvers["prod_eu"].module.dns_resolver.azurerm_private_dns_resolver.this
  to   = module.alz_connectivity[0].module.dns_resolver["prod_eu"].azurerm_private_dns_resolver.this
}

moved {
  from = module.private_dns_resolvers["prod_eu"].module.dns_resolver.azurerm_private_dns_resolver_inbound_endpoint.this["default"]
  to   = module.alz_connectivity[0].module.dns_resolver["prod_eu"].azurerm_private_dns_resolver_inbound_endpoint.this["default"]
}
...
moved {
  ...
  to   = module.alz_connectivity[0].module.dns_resolver["prod_eu"].azurerm_private_dns_resolver_outbound_endpoint.this["default"]
}
